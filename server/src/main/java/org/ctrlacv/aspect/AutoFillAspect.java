package org.ctrlacv.aspect;

import org.ctrlacv.annotation.AutoFill;
import org.ctrlacv.constant.AutoFillConstant;
...
public class AutoFillAspect {
    @Pointcut("execution(* org.ctrlacv.mapper.*.*(..)) && @annotation(org.ctrlacv.annotation.AutoFill)")
